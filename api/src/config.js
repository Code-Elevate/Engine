...
const options = {
  ...
  data_directory: {
    desc: "Absolute path to store all engine related data at",
    default: "/engine",
  ...
  repo_url: {
    ...
    default:
      "https://github.com/Code-Elevate/Engine/releases/download/pkgs/index",
    validators: [],
  },
  max_concurrent_jobs: {
...
for (const option_name in options) {
  const env_key = "ENGINE_" + option_name.to_upper_case();
